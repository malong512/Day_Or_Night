 ...
 * @Description: 可设置夜间模式AutoCompleteTextView
 * @author malong
 * @date May 18, 2015 6:24:13 PM
 */
public class ThemeAutoCompleteTextView extends AutoCompleteTextView {
     ...
     * @date May 18, 20156:25:12 PM
     */
    public ThemeAutoCompleteTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public ThemeAutoCompleteTextView(Context context, AttributeSet attrs, int defStyle) {
